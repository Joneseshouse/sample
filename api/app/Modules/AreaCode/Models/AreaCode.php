...
namespace App\Modules\AreaCode\Models;
...
class AreaCode extends Model{
	...
	public static $fieldDescriptions = [
		...
		'code' => 'str,required|max:5',
		'delivery_fee_unit' => 'int,required',
	];

	public static $searchFields = ['title', 'code'];

	public static function list($params=[], $keyword=null, $orderBy='-id'){
		try{
			$orderBy = Tools::parseOrderBy($orderBy);
			$listItem = AreaCode::where($params);
