...
<body>
        ...
        <div class="main-width position-relative">
            <div class="row-fluid">
                <div class="span2">
                    <div class="b-logo">
                        <a href="/">
                            <img src="/public/static/images/logo.png" alt="{{config('app.app_name')}}" title="{{config('app.app_name')}}" style="max-height: 85px;" />
                        </a>
                    </div>
                </div>
                <div class="span5">
                        ...
                        <ul class="fr-cr">
                            ...
                            <li class="fr-li">
                                <div class="padd-control">
                                    <a href="{{config('app.extension_url')}}manage">
                            ...
                            <li class="fr-li">
                                <div class="padd-control">
                                    <a href="{{config('app.base_url')}}user">
        ...
        <div class="main-width">
            <div id="smoothmenu1" class="navhor">
                <ul>
                    ...
                    <li>
                        <a class="parent1" href="{!! route('Landing.list', ['category_uid' => $category->uid]) !!}" title="{{$category->title}}">
                            {{ $category->title }}
                        </a>
                        <ul>
                            @foreach($category->articles()->orderBy('order', 'desc')->get() as $article)
                                <li>
                                    <a
                                        href="{!! route('Landing.detail', ['id' => $article->id, 'slug' => $article->slug]) !!}"
                                        title="{{$article->title}}">
                                        {{ $article->title }}
                                    </a>
                                </li>
                    ...
                    @endforeach
                    <li>
                        <a class="parent1" href="{!! route('Landing.register') !!}" title="Liên hệ">
                            Liên hệ
                        </a>
                    </li>
                </ul>
	...
	<div class="fix-icon-right" id="fixedmenu">
        <div class="row-fluid">
            <ul class="unstyled">
                <li>
                    <a href="" title="Top"><img src="/public/static/images/gotop.gif" class="scrollup" alt="{{config('app.app_name')}}" title="{{config('app.app_name')}}" /></a>
                </li>
            </ul>
        </div>
    </div>

	@include('Landing::share.footer')
</body>
</html>
