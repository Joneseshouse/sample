...
return [
	...
	'max_address' => 'Bạn không thể tạo thêm địa chỉ mới',
	'area_code_not_exist' => 'Mã vùng không tồn tại.',
	'missing_user_from_bill_of_landing' => 'Danh sách vận đơn không đơn không đủ thông tin hoặc là của nhiều hơn 1 khách hàng.',
	'stock_quantity_larger_than_inventory_quantity' => 'Số lượng xuất ra lớn hơn số lượng hàng tồn.',
	'bill_checked' => 'Vận đơn này đã được kiểm trước đây.'
];