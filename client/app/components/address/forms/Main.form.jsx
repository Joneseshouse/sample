		...
		return (
			<form
				...
				<Field
      				name="area_code_id"
      				type="select"
      				options={store.getState().addressReducer.listAreaCode}
      				onInputChange={value => {}}
      				component={FormInput}
				...
				<Field
      			...
      			<Field
      				...
      				type="text"
      				component={FormInput}
      				label={this.props.labels.fullname}/>
      			<Field
      				name="default"
      				type="checkbox"
      				component={FormInput}
      				label={this.props.labels.default}/>
...
function mapStateToProps(state){
	return {
		initialValues: state.addressReducer.obj
	}
}
...
const form = reduxForm({
	form: 'AddressMainForm', // a unique name for this form
