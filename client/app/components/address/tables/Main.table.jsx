...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.addressReducer.list, newProps.addressReducer.list);
		if(sameList){
	...
	_renderRightTool(value, row, index){
		return (
			<TableRightTool
				...
				onPrint={() => this.props.onPrint(row)}
			/>
		);
	}
		...
		return (
			<div>
				...
				<Table
					...
					data={this.props.addressReducer.list}
					/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.addressReducer.pages}
