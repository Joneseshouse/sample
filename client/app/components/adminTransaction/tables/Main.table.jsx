...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.adminTransactionReducer.list, newProps.adminTransactionReducer.list);
	...
	render() {
			...
			columnData.push(
				{
					...
					dataIndex: key,
					key,
					render: (value, row, index) => Tools.tableData(labels.mainForm, row, key, this.props.params, store.getState().adminTransactionReducer)
				}
			);
		});
		...
		let data = [total, ...this.props.adminTransactionReducer.list];
		return (
			<div>
				<Table
					columns={columns}
				...
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.adminTransactionReducer.pages}
