...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.areaCodeReducer.list, newProps.areaCodeReducer.list);
		if(sameList){
		...
		return (
			<div>
				...
				<Table
					...
					data={this.props.areaCodeReducer.list}/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.areaCodeReducer.pages}
