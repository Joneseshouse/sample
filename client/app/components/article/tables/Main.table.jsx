...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.articleReducer.list, newProps.articleReducer.list);
		if(sameList){
		...
		return (
			<div>
				...
				<Table
					...
					data={this.props.articleReducer.list}
					/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.articleReducer.pages}
