...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.bankReducer.list, newProps.bankReducer.list);
		if(sameList){
			...
			columnData.push(
				{
					...
					dataIndex: key,
					key,
					render: (value, row, index) => Tools.tableData(labels.mainForm, row, key, this.props.params, store.getState().bankReducer)
				}
			);
		});
		const columns = [
		...
		return (
			<div>
				...
				<Table
					...
					data={this.props.bankReducer.list}
					/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.bankReducer.pages}
