...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.bannerReducer.list, newProps.bannerReducer.list);
		if(sameList){
		...
		return (
			<div>
				...
				<Table
					...
					data={this.props.bannerReducer.list}
					/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.bannerReducer.pages}
