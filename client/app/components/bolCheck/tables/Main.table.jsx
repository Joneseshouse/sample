...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.bolCheckReducer.list, newProps.bolCheckReducer.list);
		if(sameList){
		...
		return (
			<div>
				<Table
					...
					data={this.props.bolCheckReducer.list}/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.bolCheckReducer.pages}
