...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.bolDailyReducer.list, newProps.bolDailyReducer.list);
		if(sameList){
		...
		return (
			<div>
				<Table
					...
					data={this.props.bolDailyReducer.list}/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.bolDailyReducer.pages}
