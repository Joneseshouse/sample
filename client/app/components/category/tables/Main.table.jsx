...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.categoryReducer.list, newProps.categoryReducer.list);
		if(sameList){
			...
			columnData.push(
				{
					...
					dataIndex: key,
					key,
					render: (value, row, index) => Tools.tableData(labels.mainForm, row, key, this.props.params, store.getState().categoryReducer)
				}
			);
		});
		const columns = [
		...
		return (
			<div>
				...
				<Table
					...
					data={this.props.categoryReducer.list}
					/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.categoryReducer.pages}
