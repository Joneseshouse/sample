...
class CnBillOfLandingLayout extends React.Component {
	constructor(props) {
		super(props);
		this.state = {};
	}
...
CnBillOfLandingLayout.propTypes = {
	bulkRemove: PropTypes.bool
};

CnBillOfLandingLayout.defaultProps = {
	bulkRemove: true
};

export default CnBillOfLandingLayout;
