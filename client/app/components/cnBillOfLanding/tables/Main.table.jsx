...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
        const sameList = Tools.isSameCollection(
            this.props.cnBillOfLandingReducer.list, 
            newProps.cnBillOfLandingReducer.list
        );
		if(sameList){
		...
		return (
			<div>
				...
				<Table
					...
					data={this.props.cnBillOfLandingReducer.list}
					/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.cnBillOfLandingReducer.pages}
