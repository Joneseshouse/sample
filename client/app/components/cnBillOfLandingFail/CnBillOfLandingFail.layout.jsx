...
class CnBillOfLandingFailLayout extends React.Component {
	constructor(props) {
		super(props);
		this.state = {};
	}
						...
						<div className="custom-modal-content">
							<div>
								<strong className="red">
									{this.props.cnBillOfLandingFailReducer.obj.error_note}
								</strong>
							</div>
							<hr/>
							<MainForm
								...
								initialValues={this.props.cnBillOfLandingFailReducer.obj}
								submitTitle="Save">
...
CnBillOfLandingFailLayout.propTypes = {
	bulkRemove: PropTypes.bool
};

CnBillOfLandingFailLayout.defaultProps = {
	bulkRemove: true
};

export default CnBillOfLandingFailLayout;
