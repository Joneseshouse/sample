...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.cnBillOfLandingFailReducer.list, newProps.cnBillOfLandingFailReducer.list);
		if(sameList){
		...
		return (
			<div>
				...
				<Table
					...
					data={this.props.cnBillOfLandingFailReducer.list}/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.cnBillOfLandingFailReducer.pages}
