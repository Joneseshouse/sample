...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.collectBolReducer.list, newProps.collectBolReducer.list);
		if(sameList){
		...
		return (
			<div>
				...
				<Table
					...
					data={this.props.collectBolReducer.list}/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.collectBolReducer.pages}
