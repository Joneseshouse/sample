...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.contactReducer.list, newProps.contactReducer.list);
		if(sameList){
		...
		return (
			<div>
				...
				<Table
					...
					data={this.props.contactReducer.list}/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.contactReducer.pages}
