...
import {labels as exportBillDetailLabes} from '../exportBillDetail/_data';
...
import MainForm from '../exportBillDetail/forms/Main.form';
import FilterForm from './forms/Filter.form';
import WaitingMessage from 'utils/components/WaitingMessage';


class ExportBillLayout extends React.Component {
    static propTypes = {
        ...
        return (
            <div>
                ...
                <CustomModal
                    ...
                    size="md"
                    title="ExportBill manager"
                    >
                    <div>
                        <div className="custom-modal-content">
                            <MainForm
                                onSubmit={this.props.onChange}
                                labels={exportBillDetailLabes.mainForm}
                                initialValues={this.props.exportBillReducer.obj}
                                submitTitle="Save">
...
export default ExportBillLayout;
