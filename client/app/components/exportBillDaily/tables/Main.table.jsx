...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.exportBillDailyReducer.list, newProps.exportBillDailyReducer.list);
		if(sameList){
		...
		return (
			<div>
				<Table
					...
					data={this.props.exportBillDailyReducer.list}/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.exportBillDailyReducer.pages}
