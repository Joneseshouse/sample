...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.grabbingReducer.list, newProps.grabbingReducer.list);
		if(sameList){
	...
	_renderAddButton(){
		return (
			<TableAddButton
				title="Upload"
				onExecute={()=>this.props.onUploadData()}
			/>
		);
	}
		...
		return (
			<div>
				...
				<Table
					...
					data={this.props.grabbingReducer.list}
					/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.grabbingReducer.pages}
