...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.lostReducer.list, newProps.lostReducer.list);
		if(sameList){
			...
			columnData.push(
				{
					...
					dataIndex: key,
					key,
					render: (value, row, index) => Tools.tableData(labels.mainForm, row, key, this.props.params, store.getState().lostReducer)
				}
			);
		});
		const columns = [
		...
		return (
			<div>
				...
				<Table
					...
					data={this.props.lostReducer.list}/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.lostReducer.pages}
