	...
	_renderRightTool(row, index){
		return (
			<MainTableRightTool
				...
				onDraftToNew={this.props.onDraftToNew}
			...
			<table>
				<tbody>
					<tr>
						<td>Đã t.toán: &nbsp;</td>
						<td>
							{row.bol_statistics.paid_purchase} / {row.bol_statistics.total_purchase}
						</td>
					</tr>
					<tr>
						<td>Kho TQ: &nbsp;</td>
			...
			<tr>
				...
				<td className="center-align">
					<div className="border-bottom">
						<Link to={Tools.toUrl('order', [row.type, row.status, row.id])}>
							{row.uid}
						</Link>
					</div>
					<div>
				...
				<td className="left-align">
					<div className="border-bottom">
						<strong>Đ.giá v.chuyển:</strong> {Tools.numberFormat(row.delivery_fee_unit)}
					</div>
					<div className="border-bottom">
				...
				<td className="right-align">
					₫{Tools.numberFormat(Math.floor(row.total))}
				</td>
				<td>
					<div className="border-bottom">
