...
@connect(
	state => ({
		initialValues: state.orderStatisticsReducer.obj
	}), dispatch => ({
		...bindActionCreators(actionCreators, dispatch)
	})
)
@reduxForm({
	form: 'OrderStatisticsMainForm', // a unique name for this form
				...
				<div>
					...
					<Field
	      			...
	      			<Field
	      				name="status"
	      				type="select"
	      				options={store.getState().orderStatisticsReducer.listStatus}
	      				onInputChange={value => {}}
	      				component={FormInput}
		...
		return (
			<form
				...
				<Field
      				name="address_id"
      				type="select"
      				options={store.getState().orderStatisticsReducer.listAddress}
      				onInputChange={value => {}}
      				component={FormInput}
