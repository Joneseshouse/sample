...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.orderStatisticsReducer.list, newProps.orderStatisticsReducer.list);
			...
			columnData.push(
				{
					...
					dataIndex: key,
					key,
					render: (value, row, index) => Tools.tableData(labels.mainForm, row, key, this.props.params, store.getState().orderStatisticsReducer)
				}
			);
		});
		let columns = [...columnData];
		let data = [total, ...this.props.orderStatisticsReducer.list];
		return (
			<div>
				<Table
					columns={columns}
				...
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.orderStatisticsReducer.pages}
