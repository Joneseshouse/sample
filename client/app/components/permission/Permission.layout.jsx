...
import MainForm from 'components/permission/forms/Main.form';
import WaitingMessage from 'utils/components/WaitingMessage';

class PermissionLayout extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
		};
				...
				<CustomModal
					...
					<div>
						<div className="custom-modal-content">
							<MainForm
								obj={this.props.permissionReducer.obj}
