	...
	render() {
		...
		return (
			<form
				...
				<div>
					<strong>{this.props.obj.route}</strong>
				</div>
				<hr/>
				<Field
      				name="title"
      			...
      			<Field
      				...
      				type="text"
      				component={FormInput}
      				label={this.props.labels.action}/>
...
function mapStateToProps(state){
	return {
		initialValues: state.permissionReducer.obj
	}
}
...
const form = reduxForm({
	form: 'PermissionMainForm', // a unique name for this form
