...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.permissionReducer.list, newProps.permissionReducer.list);
		if(sameList){
	...
	_renderAddButton(){
		return (
			<button
				type="button"
				onClick={() => {this.props.onSync(); this.setState({forceUpdate: true})}}
		...
		return (
			<div>
				...
				<Table
					...
					data={this.props.permissionReducer.list}
					/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.permissionReducer.pages}
