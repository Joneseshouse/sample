      			...
      			<div className="row">
      				<div className="col-sm-4">
						<Field
		      				...
		      				type="number"
		      				component={FormInput}
		      				label={this.props.labels.buy_rate}/>
      				</div>
      				<div className="col-sm-4">
						<Field
		      				name="sell_rate"
		      				type="number"
		      				component={FormInput}
		      				label={this.props.labels.sell_rate}/>
      				</div>
      				<div className="col-sm-4">
						<Field
		      				name="order_rate"
		      				type="number"
		      				component={FormInput}
		      				label={this.props.labels.order_rate}/>
      				</div>
      			</div>
...
function mapStateToProps(state){
	return {
		initialValues: state.rateLogReducer.obj
	}
}
...
const form = reduxForm({
	form: 'RateLogMainForm', // a unique name for this form
