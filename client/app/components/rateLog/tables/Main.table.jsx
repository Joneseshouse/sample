...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.rateLogReducer.list, newProps.rateLogReducer.list);
		if(sameList){
		...
		return (
			<div>
				...
				<Table
					...
					data={this.props.rateLogReducer.list}/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.rateLogReducer.pages}
