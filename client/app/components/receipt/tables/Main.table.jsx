...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.receiptReducer.list, newProps.receiptReducer.list);
	...
	render() {
		...
		let data = [total, ...this.props.receiptReducer.list];
		return (
			<div>
				<Table
					columns={columns}
				...
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.receiptReducer.pages}
