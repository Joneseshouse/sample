...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.roleReducer.list, newProps.roleReducer.list);
		if(sameList){
		...
		return (
			<div>
				...
				<Table
					...
					data={this.props.roleReducer.list}
					/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.roleReducer.pages}
