...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
		const sameList = Tools.isSameCollection(this.props.roleTypeReducer.list, newProps.roleTypeReducer.list);
		if(sameList){
		...
		return (
			<div>
				...
				<Table
					...
					data={this.props.roleTypeReducer.list}
					/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.roleTypeReducer.pages}
