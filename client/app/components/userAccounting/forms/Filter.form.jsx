...
@reduxForm({
	form: 'UserAccountingFilterForm', // a unique name for this form
								...
								<div className="row">
									<div className="col-md-3">
										<Field
						      				name="admin_id"
						      				type="select"
						      				options={store.getState().userAccountingReducer.listAdmin}
						      				onInputChange={value => {}}
						      				component={FormInput}
									...
									<div className="col-md-3">
										<Field
						      				name="user_id"
						      				type="select"
						      				options={store.getState().userAccountingReducer.listUser}
						      				onInputChange={value => {}}
						      				component={FormInput}
									...
									<div className="col-md-3">
										<Field
						      				name="type"
						      				type="select"
						      				options={store.getState().userAccountingReducer.listType}
						      				onInputChange={value => {}}
						      				component={FormInput}
									...
									<div className="col-md-3">
										<Field
						      				name="money_type"
						      				type="select"
						      				options={store.getState().userAccountingReducer.listMoneyType}
						      				onInputChange={value => {}}
						      				component={FormInput}
