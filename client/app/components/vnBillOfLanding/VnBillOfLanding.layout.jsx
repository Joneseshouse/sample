...
class VnBillOfLandingLayout extends React.Component {
	constructor(props) {
		super(props);
		this.state = {};
	}
...
VnBillOfLandingLayout.propTypes = {
	bulkRemove: PropTypes.bool
};

VnBillOfLandingLayout.defaultProps = {
	bulkRemove: true
};

export default VnBillOfLandingLayout;
