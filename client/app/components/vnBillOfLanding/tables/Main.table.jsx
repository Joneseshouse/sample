...
class MainTable extends React.Component {
	...
	shouldComponentUpdate(newProps, newState) {
        const sameList = Tools.isSameCollection(
            this.props.vnBillOfLandingReducer.list, 
            newProps.vnBillOfLandingReducer.list
        );
		if(sameList){
		...
		return (
			<div>
				...
				<Table
					...
					data={this.props.vnBillOfLandingReducer.list}
					/>
				<div className="pagination-wrapper">
					<Paginator
						pageCount={this.props.vnBillOfLandingReducer.pages}
